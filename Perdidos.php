...
$(document).ready(function(){
   $("#campo1").change(function () {
           $("#campo1 option:selected").each(function () {
            elegido=$(this).val();
            $.post("Perdidos.php", { elegido: elegido }, function(data){
            $("#campo2").html(data);
            });            
        });
   })
	 ...
	 <div class="block-title">
        ...
        <ul id="nav_vert">
            ...
            <!--li class="separator">&nbsp;</li-->
                                ...
                                <ul>
                                                                                                   <li><a href="../pagina web/perdidos.html" class="open">Encuentra a tu animal perdido</a>
                                            </li>
...
// ]]></script>
            ...
            <div class="title-block">
              ...
              <form name="pasa_select" action="Perdidos2.php" method="GET">
<select name="campo1">
...
echo "<option value=\"$dato2[raca_id]\">$dato2[raca_nom]</option>";
}
mysqli_close($con);
?>
