...
<!-- saved from url=(0046)http://www.misterguau.com/index.php/peces.html -->
...
<link rel="stylesheet" type="text/css" href="./PECES_files/reset.css" media="all">
<link rel="stylesheet" type="text/css" href="./PECES_files/styles.css" media="all">
<link rel="stylesheet" type="text/css" href="./PECES_files/clears.css" media="all">
<link rel="stylesheet" type="text/css" href="./PECES_files/j2t-rewardpoints.css" media="all">
<link rel="stylesheet" type="text/css" href="./PECES_files/print.css" media="print">
<script type="text/javascript" src="./PECES_files/prototype.js"></script>
<script type="text/javascript" src="./PECES_files/validation.js"></script>
<script type="text/javascript" src="./PECES_files/builder.js"></script>
<script type="text/javascript" src="./PECES_files/effects.js"></script>
<script type="text/javascript" src="./PECES_files/dragdrop.js"></script>
<script type="text/javascript" src="./PECES_files/controls.js"></script>
<script type="text/javascript" src="./PECES_files/slider.js"></script>
<script type="text/javascript" src="./PECES_files/js.js"></script>
<script type="text/javascript" src="./PECES_files/form.js"></script>
<script type="text/javascript" src="./PECES_files/menu.js"></script>
<script type="text/javascript" src="./PECES_files/translate.js"></script>
<script type="text/javascript" src="./PECES_files/cookies.js"></script>
<link rel="canonical" href="./PECES_files/PECES.html">
<!--[if lt IE 8]>
...
<script type="text/javascript" src="./PECES_files/getAllAppDefault.esi"></script><script type="text/javascript" src="./PECES_files/checkOAuth.esi"></script><link rel="stylesheet" type="text/css" href="./PECES_files/buttons.4d4008011051a133a045fe92d3143ad4.css"></head>
<body class=" catalog-category-view categorypath-peces-html category-peces">
<div class="wrapper" id="wrap">
        <div class="page">
        <div class="header_new">
  	<h1>MISTER GUAU</h1>
  <a href="http://www.misterguau.com/index.php/"><img src="./PECES_files/logo.jpg" width="630" height="75"></a>
  </div>
  <div class="bC_caja">
    <ul class="menu-left">
   ...
   <div class="main-block">
	 ...
	 <div class="block-title">
        ...
        <ul id="nav_vert">
            ...
            <!--li class="separator">&nbsp;</li-->
                                                <li><a href="./anuncios.html" class="open">Anuncios</a>
                                <ul>
                                                                                                   <li><a href="../pagina web/perdidos.php" class="open">PERDIDOS</a>
                                            </li>
                                                                                                   <li><a href="../pagina web/encontrados.html">ENCONTRADOS</a>
                                            </li>
...
<p>&nbsp;</p>
<p><a title="Facebook MISTERGUAU" href="https://www.facebook.com/misterguau" target="_blank"><img src="./PECES_files/Facebook_MISTERGUAU.png" alt="Facebook MISTERGUAU"></a><a title="Youtube MISTERGUAU" href="http://www.youtube.com/user/misterguaucenter" target="_blank"><img src="./PECES_files/Youtube_MISTERGUAU.png" alt="Youtube MISTERGUAU"></a></p>
<p>&nbsp;</p>
<p><a title="Outlet MISTERGUAU" href="http://www.misterguau.com/index.php/outlet-corner-las-mejores-ofertas.html" target="_self"><img src="./PECES_files/Oulet_1.jpg" alt="Outlet hasta -70%"></a></p>
<p>&nbsp;</p>
...
<p style="text-align: left;">&nbsp;</p>
<p>
<script src="./PECES_files/buttons.js" type="text/javascript"></script>
            ...
            <div class="title-block">
								<div class="border-left">
									<div class="border-right">
										<div class="border-top">
											<div class="corner-left-top">
												<div class="corner-right-top">                                <h2>Perdidos</h2>
            </div>
											</div>
										</div>
									</div>
...
//echo "campo2: $_POST[campo2]";

  $con = mysqli_connect('localhost', 'root', 'DAW22015', 'bd_botiga_animals');
  $str = "SELECT * FROM `tbl_tipus_animal`, `tbl_raca`, `tbl_anunci`, `tbl_municipi` WHERE `tbl_tipus_animal`.`tipus_anim_id` = $_POST[campo1] AND `tbl_raca`.`tipus_anim_id` = `tbl_tipus_animal`.`tipus_anim_id` AND `tbl_raca`.`raca_id` = $_POST[campo2] AND `tbl_anunci`.`raca_id` = `tbl_raca`.`raca_id` AND `tbl_municipi`.`municipi_id` = $_POST[campo3] AND `tbl_municipi`.`municipi_id` = `tbl_anunci`.`mun_id` ORDER BY `tbl_tipus_animal`.`tipus_anim_id` ASC";
 // echo "$str</br>";
  ...
  $pro = mysqli_fetch_array($datos);
      ...
      echo "nom: $pro[anu_nom]</br>"; 
      echo "descripció: $pro[anu_contingut]</br>";
      echo "data: $pro[anu_data]</br>";
      $fichero="../pagina web/img/$pro[anu_foto]";
      if(file_exists($fichero)) {
      echo "<img src='$fichero'></br></br>";
      }
    }
  
   else {
    echo "NO SE HAN ENCONTRADO ANIMALES DE ESTA RAZA, LO SENTIMOS MUCHO GUAPO";
  }
...
<div class="formaPago">
        <img src="./PECES_files/servired.jpg" width="45" height="30">
        <img src="./PECES_files/maestro.jpg" width="45" height="30">
        <img src="./PECES_files/VISA(1).jpg" width="45" height="30">
        <img src="./PECES_files/americanexpress.jpg" width="45" height="30"> 
        <img src="./PECES_files/euro6000.jpg" width="45" height="30"> 
        <img src="./PECES_files/4b.jpg" width="45" height="30"> 
        <img src="./PECES_files/mastercard.jpg" width="45" height="30"> 
        <img src="./PECES_files/paypal.jpg" width="45" height="30">
        <img src="./PECES_files/trasnferencia.jpg" width="75" height="30" class="last"> 
</div>
	...
	<div class="main-block">
            ...
            © 2010 MISTERGUAU. Todos los derechos reservados. Centro profesional animal, S.L. Núcleo zoológico: B2500920                    </div>
        <div class="col-2">
            <ul>
...
<div id="stcpDiv" style="position: absolute; top: -1999px; left: -1988px;">ShareThis Copy and Paste</div><iframe id="stSegmentFrame" name="stSegmentFrame" src="./PECES_files/getSegment.html" frameborder="0" scrolling="no" width="0px" height="0px" style="display:none;"></iframe><div id="stwrapper" class="stwrapper stwrapper4x" style="display: none;"><iframe allowtransparency="true" id="stLframe" class="stLframe" name="stLframe" frameborder="0" scrolling="no" src="./PECES_files/index.e04a19abf1c276d639d3e98702185dab.html"></iframe></div><div id="stOverlay" onclick="javascript:stWidget.closeWidget();"></div></body></html>